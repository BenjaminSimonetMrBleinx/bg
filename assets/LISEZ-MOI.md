...
Pose tes fichiers dans `assets/sons/`, en respectant les sous-dossiers du
...
Git ne suit pas les dossiers vides. Sans lui, `assets/` disparaîtrait du prochain clone, et
